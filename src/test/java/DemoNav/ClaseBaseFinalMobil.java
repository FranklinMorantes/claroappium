...

{
	...
	@SuppressWarnings("rawtypes")
	public void scrollVertical(File rutaCarpeta, int x, int y, int a, int b) throws Exception
		{
			TouchAction touch = new TouchAction(driver);
			touch.press(PointOption.point(x ,y))
			.waitAction(WaitOptions.waitOptions(Duration.ofSeconds(2)))
			.moveTo(PointOption.point(a,b))
			.release().perform();
			captureScreen(rutaCarpeta);
	...
	public void tocarPantalla(int i, int j)
	{
	@SuppressWarnings("rawtypes")
	TouchAction touch = new TouchAction(driver);
	touch.press(PointOption.point(i,j)).release().perform();
	}
